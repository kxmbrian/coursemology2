...
//= require templates/discussion/post

// Need answers helper still?
// translations -- need to add and need to remove. To check PRs
...
var EDIT_DISCUSSION_POST = (function($, FORM_HELPERS, COURSE_HELPERS) {
  ...
  var render = FORM_HELPERS.renderFromPath('templates/discussion/');
