  ...
  with_tenant(:instance) do
    ...
    context 'As a Course Teaching Assistant' do
      ...
      scenario 'I can disburse experience points' do
        ...
        visit disburse_points_course_users_path(course)
        ...
        expect(current_path).to eq(disburse_points_course_users_path(course))
      end
    end
  end
end
